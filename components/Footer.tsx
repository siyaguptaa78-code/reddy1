...
export const Footer: React.FC = () => {
 ...
 Operating since 2010, Reddy Anna provides secure services across India. Get your official ID in minutes and join thousands of daily active users on the most trusted sports exchange platform.
 </p>
 ...
 <span className="text-gray-400 font-bold">18+ Only.</span> Warning: Online and gambling can be addictive and pose a financial risk. Only persons aged 18 years and over are permitted to engage in such activities solely for entertainment purposes. This platform is protected by SSL encryption security certificates.
 </p>
 </div>
 </footer>
 );
