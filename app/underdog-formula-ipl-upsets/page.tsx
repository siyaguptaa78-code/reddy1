...
export default function UnderdogFormulaPage() {
 ...
 <p>
 The Phase Dominance Score is a starting filter, not a complete system. There are four variables it systematically cannot capture, and ignoring them produces overconfident selections.
 </p>
