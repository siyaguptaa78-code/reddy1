...
export const metadata: Metadata = {
 title: "Cricket ID | Official Reddy Anna Cricket ID | Instant Delivery",
 description: "Get your official Reddy Anna Cricket ID instantly via WhatsApp. Bet on live cricket, IPL and T20 World Cup with India's most trusted platform.",
  alternates: { canonical: "https://reddynow.com/reddy-anna-id/cricket-id" },
 openGraph: {
 title: "Cricket ID | Reddy Anna Book",
 description: "Get your official Reddy Anna Cricket ID instantly via WhatsApp.",
