...
export const metadata: Metadata = {
 ...
 description: "Learn about Reddy Anna Book – India's trusted cricket ID platform. Instant ID delivery, secure payments & 24/7 WhatsApp support since 2010.",
  alternates: { canonical: "https://reddynow.com/about-us" },
 openGraph: {
 title: "About Us | Reddy Anna Book",
 description: "Learn about Reddy Anna Book – India's trusted cricket ID platform.",
