...
export default function sitemap(): MetadataRoute.Sitemap {
 ...
 return [
    ...
    { url: `${baseUrl}/european-open-2026-atp-guide`, lastModified, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${baseUrl}/reddy-anna-id/ipl-id`, lastModified, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/reddy-anna-sports/cricket`, lastModified, changeFrequency: 'daily', priority: 0.9 },
    { url: `${baseUrl}/reddy-anna-sports/football`, lastModified, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/reddy-anna-sports/horse-racing`, lastModified, changeFrequency: 'weekly', priority: 0.7 },
    { url: `${baseUrl}/reddy-anna-sports/live`, lastModified, changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/reddy-anna-sports/tennis`, lastModified, changeFrequency: 'weekly', priority: 0.7 },
