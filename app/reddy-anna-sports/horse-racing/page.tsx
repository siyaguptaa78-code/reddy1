...
export const metadata: Metadata = {
 title: "Horse Racing | Live Odds | Reddy Anna Book",
 description: "Bet on live horse racing events with competitive odds on Reddy Anna Book. India's trusted sports platform with instant payout guarantee.",
  alternates: { canonical: "https://reddynow.com/reddy-anna-sports/horse-racing" },
 openGraph: {
 title: "Horse Racing | Reddy Anna Book",
