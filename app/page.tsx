          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <Link href="/reddy-anna-sports/cricket-betting" className="md:col-span-8 group relative rounded-3xl overflow-hidden border border-white/10 aspect-[4/3] md:aspect-auto h-full min-h-[400px]">
                <img src={CONFIG.images.cricketCardBg} alt="Cricket Betting" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                ...
                <div className="absolute bottom-0 left-0 p-6 md:p-10 w-full flex justify-between items-end">
                  <div>
                    ...
                    <h3 className="text-4xl md:text-5xl font-black text-white mb-2 drop-shadow-md">Cricket Betting</h3>
              ...
              <div className="md:col-span-4 flex flex-col gap-6">
                <Link href="/reddy-anna-sports/football-betting" className="group relative rounded-3xl overflow-hidden border border-white/10 flex-1 min-h-[200px]">
                  <img src={CONFIG.images.footballCardBg} alt="Football Betting" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                ...
                <Link href="/reddy-anna-sports/tennis-betting" className="group relative rounded-3xl overflow-hidden border border-white/10 flex-1 min-h-[200px]">
                  <img src={CONFIG.images.tennisCardBg} alt="Tennis Betting" className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
                  <div className="absolute bottom-0 left-0 p-6">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#111827] to-[#0a0f1c] border border-white/10 rounded-3xl p-8 md:p-12 relative overflow-hidden flex flex-col justify-center">
              <div className="relative z-10">
                ...
                <p className="text-gray-400 mb-8 max-w-sm text-lg">Experience faster betting, live score updates, and exclusive app-only features on your mobile device.</p>
          ...
          <div className="max-w-6xl mx-auto bg-gradient-to-br from-amber-900/40 via-[#0a0f1c] to-[#0a0f1c] border border-amber-500/20 rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden shadow-[0_0_80px_rgba(245,158,11,0.1)]">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto font-medium">
                Get your official Reddy Anna ID instantly. Join India's most trusted sports betting exchange and claim your welcome bonus.
              </p>
